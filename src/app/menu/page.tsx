  ...
  return (
    <main className="title">
       <div className="bg-[url('/menu-1.png')] h-screen">
          <h1 className="text-8xl font-serif font-bold text-white pt-28 px-20">
            View Our<br></br> New Menu</h1>
          <p className="text-sm font-semibold text-white pt-5 px-20">
            The freshest ingredients for you every day</p>
          </div>
           
{/* 2nd Section */}
    <section>
  <div>
          <h1 className="text-6xl text-center pt-32 pb-5 px-10 font-serif font-bold
           text-lime-950 bg-[url('/menu-2.png')] bg-no-repeat bg-right-top
            bg-[length:300px_200px]">Starters</h1>
          <p className="text-sm text-center px-10 text-black">
            This is a section of your menu, Give your section a brief description.</p>
          </div>
    ...
    <section className="m-10">
         <div className="pt-10">
          ...
          <p className="text-sm text-center px-10 pt-5  text-black">
            This is a section of your menu, Give your section a brief description.</p>
          </div>
